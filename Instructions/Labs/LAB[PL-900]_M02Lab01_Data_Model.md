...
1.  您應將 **Visits.xls** 檔案儲存在桌面上。 請下載 [Visits.xls](https://github.com/MicrosoftLearning/PL-900-Microsoft-Power-Platform-Fundamentals/raw/master/Allfiles/Visits.xlsx) 檔案 (若您尚未下載)。
...
8.  找到並選取您稍早已下載的 **Visits.xls** 檔案。 *(請注意：上傳檔案可能會需要一或二分鐘的時間。如果出現對應錯誤的訊息，請無需擔心，我們稍後會修正這些問題。)*
...
2.  請注意 [造訪情形] 資料表有許多索引標籤。 這包括 Cikynns、關聯性、商務規則、檢視等等。 

3.  選取 [造訪情形] 資料表的 [資料] 索引標籤。 這位在 [資料表] \> [造訪情形] 之下。

3.  確認資料表中有記錄。 您可以在右上角選取檢視名稱，並將其變更為 **所有資料行** 來變更檢視。 
