...
5. 在 [排序依據] 下，選取 [X] 以移除 [名稱]，然後改為選取 [排程的開始時間]。
...
5. 在 [新增頁面] 畫面上，選擇 [Dataverse] 資料表，然後選取 [下一步] 按鈕。
...
11. 在瀏覽窗格的 [安全性群組] 下，選取 [SubArea1]。 

12. 選取**省略符號**，並在顯示的功能表中選取 [從瀏覽移除]。 
...
### <a name="task-2-test-app"></a>工作 #2：測試應用程式
