...
1. 使用左上方的階層連結（**數據表** > **費用報表** > **表表表）。** 選取 **[費用報表** ] 以返回 [ **瀏覽** 數據表屬性] 畫面。

## 工作 #2：編輯現行造訪檢視

在這項工作中，我們將修改預設的 [使用中費用報表] 檢視，併為今天的造訪建立新的檢視。
...
1. 選取**儲存後關閉**。 這會建立造訪，而且應會顯示在 [現行造訪] **** 檢視中

1. 使用 [使用中流覽 **] 旁**的下拉式清單，將檢視變更為 **[費用報表今日**到期]。 
