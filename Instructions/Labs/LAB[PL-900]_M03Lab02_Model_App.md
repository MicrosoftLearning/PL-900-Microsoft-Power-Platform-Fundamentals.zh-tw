...
- 建立名稱為 Bellows Expense Management 的新模型導向應用程式
...
1. 選取 [擁有者]**** 欄位。 在 [屬性] 面板中，將 [標籤]**** 變更為 [要求者]
...
1. 在 [排序依據... ] **** 下 選取 X 以移除 [名稱]****，然後改為選取 [報告總金額]****。

1. 選取 [報告總金額]****，將排列順序變更為 [由大至小]****。
...
1. 在畫面右側的 [顯示選項]**** 區段中，將 [標題]**** 屬性變更為 [報告]
